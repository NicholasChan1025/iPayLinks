...
namespace IPayLinks\Kernel\Log;
...
class LogManager implements LoggerInterface
{
     ...
     *
     * @param \IPayLinks\Kernel\ServiceContainer $app
     */
    ...
    {
        return new Monolog('IPayLinks', $this->prepareHandlers([new StreamHandler(
    ...
    protected function createSyslogDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SyslogHandler(
                    'IPayLinks', $config['facility'] ?? LOG_USER, $this->level($config))
            ),
        ]);
    }
